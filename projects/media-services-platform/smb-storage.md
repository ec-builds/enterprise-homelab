...
Detailed credential handling and SMB security configuration are documented in the - [Secure SMB Mount](../../docs/reference/debian/debian-smb-secure-mount.md) reference guide.
