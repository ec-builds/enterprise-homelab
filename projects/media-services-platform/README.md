...
<p align="left">
  <img src="./diagrams/media-lab-architecture.png" alt="Architecture Diagram" width="800">
  <br>
...
- [x] Decommission the original bare-metal Jellyfin deployment and repurpose the host for [network infrastructure](../network-infrastructure)
